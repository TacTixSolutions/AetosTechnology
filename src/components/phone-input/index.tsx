...
export function PhoneInput({
  ...
  return (
    <div className={cn("flex gap-2 w-full", containerClassName)}>
      <Popover open={openCommand} onOpenChange={setOpenCommand} modal={true}>
        <PopoverTrigger asChild>
          <Button
            ...
            className="w-max items-center justify-between whitespace-nowrap shrink-0"
          >
                      ...
                      <CommandItem
                        ...
                        onSelect={() => {
                          if (inputRef.current) {
                            ...
                            handlers.set(`+${country.dial_code}`);
